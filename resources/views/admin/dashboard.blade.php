    ...
    <div class="container-fluid">
        <div class="row widget-grid">
            ...
            <div class="col-xxl-auto col-xl-3 col-sm-6 box-col-6">
                <div class="row">
                    <div class="col-xl-12">
                        <a href="{{ route('admin.importation') }}">
                            <div class="card small-widget">
                                <div class="card-body primary"> <span class="f-light">Déclarations d'importations</span>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <a href="{{ route('admin.stock') }}">
                            <div class="card small-widget">
                                <div class="card-body primary"> <span class="f-light">Déclarations de stocks</span>
                                    <div class="d-flex align-items-end gap-1">
                                        <h4>{{ $stocks }}</h4>
                                    </div>
                                    <div class="bg-gradient">
